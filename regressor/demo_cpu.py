"""
SHAPY Demo - CPU Version

This is a CPU-compatible version of the original demo.py
Modifications:
- Device set to 'cpu' instead of 'cuda'
- CUDA availability check removed
- torch.cuda.synchronize() calls removed
- resource.setrlimit made cross-platform compatible
"""
import sys
import os
...
# Cross-platform resource limit handling
try:
    import resource
...
def main(
    ...
    for bidx, batch in enumerate(tqdm(body_dloader, dynamic_ncols=True)):
        ...
        # CPU timing - no cuda.synchronize needed
...
if __name__ == '__main__':
    ...
    description = 'PyTorch SMPL-X Regressor Demo (CPU Version)'
